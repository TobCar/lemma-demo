  ...
  return (
    ...
    >
      <div className="flex items-center justify-between p-5 border-b border-border">
        ...
        <Link href="/accounts" className="flex h-7 w-7 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground">
