    ...
    <DashboardLayout>
      ...
      >
        ...
        <div className="grid grid-cols-[1fr_120px_140px_180px_150px_100px] gap-4 px-6 py-4 border-b border-border">
          ...
          <div className="text-xs font-normal text-muted-foreground">Identifier</div>
          <div className="text-xs font-normal text-muted-foreground">Type</div>
          <div className="text-xs font-normal text-muted-foreground">Assigned to</div>
          <div className="text-xs font-normal text-muted-foreground text-right">Balance</div>
          <div className="text-xs font-normal text-muted-foreground text-right">Status</div>
        </div>
        ...
        <div className="divide-y divide-border">
          {paginatedItems.map((account, index) => (
            ...
            >
              ...
              <div className="text-sm text-category-blue">{account.assignedTo}</div>
              <div className="text-sm font-semibold text-foreground text-right tabular-nums">
                {formatCurrency(account.balance)}
              </div>
              <div className="text-sm text-muted-foreground text-right">{account.status}</div>
            </motion.div>
          ))}
        </div>
